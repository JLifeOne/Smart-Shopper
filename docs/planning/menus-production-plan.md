...
7. Upgrade messaging wired to real upgrade path + offline-aware limit banners (policy endpoint ready; UI gating next).
...
> **Current focus:** Close remaining Stage 1 ingestion wiring + begin Stage 2 prompt contract while frontend wires policy-driven limits and offline caches.
